...
const EmailVerificationPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2
          className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-green-500
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold
              py-3 px-4 rounded-lg shadow-lg hover:from-green-600 hover:to-emerald-700 focus:outline-none
